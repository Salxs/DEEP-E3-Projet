...
#define USE_ADC					0
	...
	#define USE_AN2			1	//Broche correspondante : PA2	//Sur la Nucleo, cette broche n'est pas cï¿½blï¿½e !
	#define USE_AN3			2	//Broche correspondante : PA3	//Sur la Nucleo, cette broche n'est pas cï¿½blï¿½e !
...
#define USE_MPU6050				0//Accï¿½lï¿½romï¿½tre et Gyroscope
#define USE_DHT11				0
